# Homework #3: Time Series Analysis (Time Series)

This repository contains the complete analysis for Homework #3 of Time Series Analysis (MATH-5027).
...
- `2025-10-31_tsa_homework-03.qmd`: The main Quarto document containing all code, analysis, and interpretation.
